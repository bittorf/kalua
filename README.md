...
--------------------------------------------
	...
	$DO "HARDWARE.TP-LINK WR841ND" ffweimar_standard patch:901-minstrel-try-all-rates.patch patch:luci-remove-freifunk-firewall.patch ffweimar_luci_standard i18n_german hostapd vtunnoZlibnoSSL i18n_german https
	#build all ar71xx based hardware images 
	$DO "HARDWARE.ar71xx" ffweimar_standard patch:901-minstrel-try-all-rates.patch patch:luci-remove-freifunk-firewall.patch ffweimar_luci_standard hostapd vtunnoZlibnoSSL i18n_german https
