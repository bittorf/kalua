...
if(isset($_GET["refresh"])) {		// refresh='true' -> monitoring_heartbeat
	...
	if (file_exists("recent/$mac")) {
		...
		$rrr = strval($_GET["rrr"] ?? '');		// experimental for map-drawing (e.g. default route)

		// FIXME! keep latest neigh-info somehow
		if (!empty($n1)) {
			file_put_contents("recent/".$mac.".changes", "UP=".$v1.";LOAD=".$v3.";h2=".$v2.";VERSION=".$v4.";r4=".$r4.";r5=".$r5.";PUBIP_REAL=".$v0.";rrr=".$rrr.";neigh=".$n1.";");
		} else {
			if (!empty($rrr)) {
				file_put_contents("recent/".$mac.".rrr", "UP=".$v1.";LOAD=".$v3.";h2=".$v2.";VERSION=".$v4.";r4=".$r4.";r5=".$r5.";PUBIP_REAL=".$v0.";rrr='".$rrr."';");
			} else {
				file_put_contents("recent/".$mac.".changes", "UP=".$v1.";LOAD=".$v3.";h2=".$v2.";VERSION=".$v4.";r4=".$r4.";r5=".$r5.";PUBIP_REAL=".$v0.";rrr=".$rrr.";");
			};
		};
		...
		touch("recent/$mac");		// security problem?
		print("UNKNOWN");
	}
